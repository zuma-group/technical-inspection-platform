    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      <div className="mb-8">
        <div className="flex flex-col sm:flex-row justify-between gap-4 ">
          ...
          <div className="flex flex-wrap md:flex-1 justify-between gap-2">
            <Link href="/dashboard" className="flex-1">
              <button className="btn btn-primary inline-flex items-center gap-2 w-full justify-center">
                <Icons.dashboard className={iconSizes.sm} />
                <span>Dashboard</span>
              </button>
            </Link>
            <Link href="/templates" className="flex-1">
              <button className="btn btn-secondary inline-flex items-center gap-2 w-full justify-center">
